...
// An individual has 3 genetically determined traits, Qini, alph, v
// (see Phenotype.hpp), and there is one locus for each trait
...
public:
    ...
    unsigned T;                 // Expected umber of rounds per individual
    ...
    flt Vn;                     // Payoff parameter
    flt Vx;                     // Payoff parameter
